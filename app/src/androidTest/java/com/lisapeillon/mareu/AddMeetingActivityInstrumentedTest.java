...
public class AddMeetingActivityInstrumentedTest {
          ...
          public void addMeetingActivity_onClickOnCreate_shouldAddMeetingOnList(){
                    ...
                    //Date
                    onView(withId(R.id.activity_addmeeting_edittext_datepicker)).perform(replaceText("2022-04-30"));
                    //Time
                    onView(withId(R.id.activity_addmeeting_edittext_timepicker)).perform(replaceText("10:30"));
                    //Room
